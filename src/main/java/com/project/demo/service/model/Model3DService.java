...
/**
 * Service for managing 3D model entities. Handles creation and updates of
 * Model3D entities based on task responses.
 *
 * @author nav
 */
@Slf4j
...
public class Model3DService {
     ...
     * @throws RuntimeException if the state is not found This method will
     * create a new Model3D if it doesn't exist, or update the existing one if
     * it does. It sets the state based on the success of the task response, and
     * extracts URLs from the JsonNode provided in the response.
     * @author nav
     */
    @Transactional
