...
class CommunityAnimalServiceUserByEmailNotFoundTest {
    ...
    @Test
    void whenNoOwnerCard_andEmailUserNotFound_thenThrows() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
                () -> service.createCommunityAnimal("me@mail.com", dto));

        org.assertj.core.api.Assertions.assertThat(ex.getMessage()).contains("Usuario autenticado no encontrado");
    }
}
